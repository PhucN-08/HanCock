                            ...
                            <div class="order-card-link">
                                ...
                                <div class="order-details">
                                    ...
                                    <div class="order-footer">
                                        <span class="order-total">Tổng tiền: <strong>{new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(val.items.reduce((pre, curr) => (pre + parseInt(curr.price)), 0) - val.giamgia)}</strong></span>
                                    </div>
                                </div>
                            </div>
                        </li>)
